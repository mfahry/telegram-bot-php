...
class Telegram {
  ...
  public function Document() {
	...
	public function FirstName() {
		return array_key_exists("first_name", $this->data["message"]["from"]) ? $this->data["message"]["from"]["first_name"] : "";
	}

/// Get the last name of the user
	public function LastName() {
		return array_key_exists("last_name", $this->data["message"]["from"]) ? $this->data["message"]["from"]["last_name"] : "";
	}

/// Get the username of the user
	public function Username() {
		return array_key_exists("username", $this->data["message"]["from"]) ? $this->data["message"]["from"]["username"] : "";
	}
